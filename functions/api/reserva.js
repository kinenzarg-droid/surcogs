...
//
// Reserva los discos por 72hs (salen del catálogo), crea las órdenes en estado
// "reservado" y devuelve el texto listo para abrir el WhatsApp de SURCOGS.
// Si en 72hs no se concreta, la reserva vence y los discos vuelven al catálogo.
const RECARGO = 0.15;
const DTO = 0.10;
// La ventana de la reserva, y el unico lugar del proyecto donde se define.
// El trabajo de la base que libera los vencidos no tiene ningun numero: mira
// la fecha que dejamos escrita aca.
//
// Son 72 y no 24 porque entre que el comprador transfiere, avisa por WhatsApp
// y Nico revisa el banco puede pasar un fin de semana entero. Con 24 horas el
// disco volvia al catalogo con la plata ya depositada.
const HORAS_RESERVA = 72;
